 <?php
    ...
    //Fichero con las variables globales
 ...
 //Mandamos correo
            if(mail("alvarofierroclavero@gmail.com", 
				...
				if($num_filas) {
					...
					// redirigir a la página ya aceptado	
				}
...
//Comprobación en la base de datos                            
			...
			if($num_filas==0) {
                ...
                if($num_filas ==0) {
                    ...
                    $resultado='<div class="alert alert-success"><strong>Hola</strong>. Nos alegramos de verte por aquí.'</div>';
                    if($fila){
                        $_SESSION['id']=$fila['id'];
